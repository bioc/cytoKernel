#' Example of processed dimensionally reduced flow cytometry
...
#'
# 'Bodenmiller, B., Zunder, E., Finck, R. et al.
# 'Multiplexed mass cytometry profiling of cellular 
# 'states perturbed by small-molecule regulators. 
# 'Nat Biotechnol 30, 858–867 (2012). 
